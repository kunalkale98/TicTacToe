...
class TicTacToe{
	...
	public void showBoard(char userLetter,char compLetter,char[] board,int pos){
	...
	public static void main(String args[]){
		...
		int toss = obj.toss(sc);
		if(toss == 1){
			userLetter = obj.chooseInput(sc);
			compLetter = (userLetter=='X')?'O':'X';
		}
		else{
			compLetter = 'X';
			userLetter = 'O';
			System.out.println("Computer played with X, you are O");

		}
		int pos = obj.userMove(sc,board);
		obj.showBoard(userLetter,compLetter,board,pos);
	}
}
